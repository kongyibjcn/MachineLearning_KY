...
def decoder_layer(encoder_states, decoder_inputs, target_sequence_len,
    ...
    # output_layer logits
    # 关于 tf.layer.Dense 的介绍： https://www.w3cschool.cn/tensorflow_python/tensorflow_python-rn6a2tps.html
...
with train_graph.as_default():
    ...
    # I don't understand why auther use tf.reverse(inputs.[-1]) to handle the inputs. I looks not make sense
    # Why here need to use tf.revers(inputs,[-1] ?
